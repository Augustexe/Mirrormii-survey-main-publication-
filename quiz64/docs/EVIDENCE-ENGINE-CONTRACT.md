...
- Only allowlisted projection-relevant context keys/values can increase cross-context support.
...
- Internal numeric position is diagnostic and never a personality percentage.
