...
- **a** “My mother. She has the complete chat history.” — facts only; facts=close=mother. You explicitly chose your mother.
- **b** “My father. An unexpected but strong contender.” — facts only; facts=close=father. You explicitly chose your father.
- **c** “My partner. They have seen the extended cut.” — facts only; facts=close=partner. You explicitly chose your partner.
- **d** “A close friend. Unfortunately, they know the lore.” — facts only; facts=close=friend. You explicitly chose a close friend.
- **e** “No recurring close person for this survey.” — facts only; facts=close=none. You explicitly chose not to use a close-person target.

### q02 — Who lives with you and the collection of useful cables? (chapter 1; context)

Pick the closest living arrangement; a mixed answer is welcome.
- **a** “Just me. Every mysterious noise is my problem.” — facts only; facts=household=alone. You explicitly reported living alone.
- **b** “People I share a home with. The sponge has a rota.” — facts only; facts=household=shared. You explicitly reported a shared household.
- **c** “Family. Privacy is more of a suggestion.” — facts only; facts=household=family. You explicitly reported living with family.
- **d** “I would rather leave the household unspecified.” — facts only; facts=household=unspecified. You chose not to specify your household.

### q03 — Three free days and enough money for one small trip. Who comes to mind first? (chapter 1; hypothetical)

A light opener: the tickets are not bought yet.
- **a** “The person who would make the story funniest.” — D1:people@general. You put a person first and begin imagining the trip.
- **b** “The place. I need a destination before a companion.” — D1:task@general. You start with the practical trip decision.
- **c** “Me. I am taking the free days and negotiating later.” — D1:self@general. You put your own capacity or desire first.
- **d** “Nobody yet. I open a map and see what happens.” — D1:task@general, D3:improvise@general. You start by exploring without choosing a companion.

### q04 — A local suggests a detour nobody has reviewed online. Your move? (chapter 1; hypothetical)

The detour is safe enough, strange enough, and inconvenient enough.
- **a** “Absolutely. The review section can meet us there.” — D2:novel@general, D3:improvise@general. You accept novelty without waiting for more information.
- **b** “Ask a few questions, then decide.” — D2:conditional@general, D3:plan@general. You add information before accepting uncertainty.
- **c** “Keep the original route. Reliable is a beautiful word.” — D2:familiar@general, D3:plan@general. You choose the known route.
- **d** “Try it only if the person with me is keen too.” — D2:conditional@general. You make novelty depend on a companion’s agreement.

### q05 — The saved restaurant has a 90-minute queue and your companion is starving. (chapter 1; hypothetical)

The famous place is still famous. Your companion is now mostly stomach.
- **a** “Find food now. The queue can write its memoir.” — D1:people@general. You respond first to the companion’s immediate need.
- **b** “Stay; we came for this and planned around it.” — D1:task@general, D3:plan@general. You prioritize the existing plan.
- **c** “Ask what they want and choose together.” — D1:people@general. You involve the companion before changing course.
- **d** “I grab something small and let them decide.” — D1:self@general. You protect your own immediate need first.

### q06 — Mid-trip, work or family asks you to handle something right now. (chapter 1; hypothetical)

It is important, but not literally on fire.
- **a** “Handle it. The trip can pause.” — D1:people@general, D11:duty@general. You put the request and its people first.
- **b** “Say I can do it later and finish the current plan.” — D1:task@general, D11:autonomy@general. You protect the plan while setting a boundary.
...
- **b** “Explain my share privately and adjust the total.” — D8:proportional@close, D7:soften@close. You request a fair split with a softer opening.
- **c** “Pay evenly; it is easier than doing arithmetic together.” — D8:absorb@close. You accept the extra cost for simplicity.
- **d** “Pay and leave the dessert unmentioned.” — D8:absorb@close, D7:avoid@close. You absorb the extra cost without raising it.

### q11 — A rough day, midnight, and a cart full of tiny solutions. (chapter 2; hypothetical)

The cart contains one lamp shaped like a duck.
- **a** “Buy the duck. It has never personally disappointed me.” — D10:act@general, D4:enjoyment@general. You make an immediate mood-related purchase.
- **b** “Sleep on it. The duck will still be a duck tomorrow.” — D10:wait@general, D3:plan@general. You delay the purchase while emotions settle.
- **c** “Read reviews and compare prices.” — D3:plan@general, D4:security@general. You gather information before spending.
- **d** “Close the app. My feelings can remain unlit.” — D10:wait@general, D4:security@general. You decline the mood-related purchase.
...
- **b** “Make a rota; the bin needs a custody agreement.” — D8:proportional@household, D3:plan@general. You organize an explicit division of labor.
- **c** “Do it myself; discussing the dish takes longer.” — D8:absorb@household, D7:avoid@household. You absorb the labor to avoid a discussion.
- **d** “Stop doing their share and wait for the magic to end.” — D8:limit@household. You stop covering the others’ share.
...
- **a** “Before 11 p.m. Tomorrow me has excellent representation.” — facts only; facts=bedtime=before 23:00. You explicitly report an earlier sleep rhythm.
- **b** “Between 11 p.m. and 1 a.m. One more episode is a reasonable proposal.” — facts only; facts=bedtime=23:00-01:00. You explicitly report a middle sleep rhythm.
...
- **b** “I worry they are upset with me and send a check-in.” — D5:worry@close, D6:support@close. You explicitly fear the silence means they are upset with you and seek contact.
...
- **b** “I tell {close} a small version, then go quiet.” — D6:selective@close. You disclose selectively to the selected person.
- **c** “I process it privately before telling {close} anything.” — D6:private@close. You initially keep the experience to yourself.
- **d** “I talk to someone else first.” — D6:selective@general. You seek another support person before the selected close person.

### q20 — In the last seven days, how many dinners arrived from a restaurant or takeaway? (chapter 3; context)

Count meals, not virtue. The delivery app is not a moral authority.
- **a** “None. The kitchen has proof of life.” — facts only; facts=takeaway=0 days / last 7. You explicitly report no takeaway dinners.
- **b** “One or two. The app knows me casually.” — facts only; facts=takeaway=1-2 days / last 7. You explicitly report occasional takeaway dinners.
...
- **b** “Eased into it gently.” — D7:soften@close. You report opening the conversation gently.
...
- **b** “Send one back, then ask to talk tonight.” — D7:soften@close, D12:repair@close. You soften the opening and arrange a conversation.
...
- **b** “Apologize and explain what happened.” — D12:explain@close, D7:soften@close. You pair an apology with context.
...
- **b** “I worry they are pulling away and want reassurance.” — D5:worry@close, D6:support@close. You fear withdrawal and seek reassurance.
- **c** “Ask directly whether we are okay.” — D5:reassurance@close, D7:direct@close. You seek explicit reassurance with a direct question.
- **d** “Wait; I do not choose an explanation yet.” — D5:uncertain@close, D6:private@close. You hold uncertainty without assigning a reason.

### q25 — A family holiday clashes with plans you made for yourself. (chapter 4; hypothetical)

Everyone says it is only one weekend, as if weekends grow on trees.
- **a** “Change my plans; family comes first this time.” — D11:duty@family, D1:people@general. You prioritize the family commitment.
- **b** “Keep my plans and explain why.” — D11:autonomy@family, D7:direct@family. You protect your plan and state the choice.
- **c** “Split the time between both.” — D11:conditional@family, D3:plan@general. You negotiate a planned compromise.
- **d** “Ask what is actually needed before deciding.” — D11:conditional@family, D1:people@general. You gather the family’s concrete need first.

### q26 — A parent or elder criticizes your choice at a family meal. (chapter 4; hypothetical)

The critique arrives in front of an audience and beside the potatoes.
- **a** “Say I am happy with my choice.” — D7:direct@family, D11:autonomy@family. You state your choice directly.
- **b** “Explain the plan so they understand.” — D7:soften@family, D3:plan@general. You give context in an attempt to lower tension.
- **c** “Make a joke and change the subject.” — D7:avoid@family. You redirect the public criticism.
- **d** “Reconsider it. Their opinion matters to me.” — D11:duty@family. You give family expectations weight in the decision.

### q27 — Family pushes a food or health habit on you. (chapter 4; hypothetical)

They have brought advice, enthusiasm, and no appointment.
- **a** “Thank them and choose my own routine.” — D11:autonomy@family, D7:soften@family. You preserve autonomy while keeping the opening gentle.
- **b** “Tell them plainly to stop.” — D11:autonomy@family, D7:direct@family. You set a direct boundary.
- **c** “Try it for their sake.” — D11:duty@family. You accommodate the family request for now.
- **d** “Change the subject and keep doing my thing.” — D11:autonomy@family, D7:avoid@family. You protect your routine without entering the argument.

### q28 — The dinner-after-a-fight scene, this time with a family member. (chapter 4; hypothetical)

They send a recipe video as if the disagreement was a minor seasoning issue.
- **a** “Reply warmly, then ask to talk about it.” — D7:direct@family, D12:repair@family. You reopen repair with the family member.
- **b** “Start with the recipe and bring it up gently later.” — D7:soften@family, D12:repair@family. You soften the repair opening.
...
- **b** “Sent a careful message about my share.” — D8:proportional@close, D7:soften@close. You report raising the uneven share privately.
...
- **d** “Talked to someone else before {close}.” — D6:selective@general. You report seeking another support person first.
...
### q34 — A colleague presents shared work and says “I” until “we” files a missing-person report. (chapter 5; hypothetical)

The credits are wrong in public.
- **a** “Mention what I contributed right there.” — D9:recognition@general, D7:direct@colleague. You clarify your contribution publicly.
- **b** “Speak to them afterward.” — D9:recognition@general, D7:soften@colleague. You address attribution privately.
- **c** “Send the lead a record of the work.” — D8:proportional@colleague, D3:plan@general. You use documentation to seek fair attribution.
- **d** “Leave it this time and keep clearer records next time.” — D3:plan@general. You defer the conflict and plan future protection.

### q35 — A friend gets the opportunity you wanted. You are happy for them. (chapter 5; hypothetical)

Your ego would prefer to lie face down for ten minutes.
- **a** “Call to celebrate; my floor moment can wait.” — D9:noncompetitive@general. You prioritize connection despite disappointment.
- **b** “Congratulate them, then mute updates briefly.” — D9:comparison@general, D6:private@friend. You support them while limiting painful comparison.
- **c** “Ask how they did it and make a plan.” — D9:competitive@general, D3:plan@general. You turn comparison into a plan.
- **d** “Wait until I can reply warmly.” — D9:comparison@general, D10:wait@general. You delay contact while emotions settle.
...
### q37 — Your mistake got the team blamed, and nobody knows it was you. (chapter 5; hypothetical)
...
### q38 — A group of friends hid something and asks you to pick a side. (chapter 5; hypothetical)
...
- **a** “Congratulated them and stayed involved.” — D9:noncompetitive@general. You report staying involved despite comparison.
- **b** “Made sure my part was visible.” — D9:recognition@general. You report protecting accurate recognition.
- **c** “Stepped back and processed it privately.” — D9:comparison@general. You report reducing comparison exposure.
- **d** “Turned the feeling into a next move.” — D9:competitive@general. You report converting comparison into action.

### q41 — A soaked stray cat looks at you like you control the weather. (chapter 6; hypothetical)

You cannot take it home. Your options are still real.
- **a** “Bring food and water. Catering, not accommodation.” — D13:bounded@general. You provide immediate care within a limit.
- **b** “Contact a rescue with cat capacity.” — D13:coordinate@general, D3:plan@general. You seek organized help.
- **c** “Ask nearby people who can help.” — D13:coordinate@general, D1:people@general. You mobilize other people to help.
- **d** “Leave; I cannot safely help right now.” — D13:limit@general, D1:self@general. You state a current capacity or safety limit.

### q42 — You are exhausted. A stranger asks for help finding their stop. (chapter 6; hypothetical)
...
- **a** “Keep the movement plan.” — D14c:planned@general, D3:plan@general. You follow the planned movement.
- **b** “Move it to another time and take the alternative.” — D14c:adjust@general, D3:plan@general. You reschedule movement around the alternative.
- **c** “Skip movement today.” — D14c:skip@general. You choose to skip the planned movement.
- **d** “Do a shorter version, then join the alternative.” — D14c:adjust@general, D3:improvise@general. You adapt the movement plan to fit both.

### q44 — What did you actually eat the last time a stressful dinner plan fell apart? (chapter 6; actual)

Choose a real recent response; skip if you have no useful example.
- **a** “Made the meal I had planned.” — D14b:planned@general. You report following the planned meal.
- **b** “Adapted the plan into a quick version.” — D14b:bounded@general. You report adapting the meal within a boundary.
- **c** “Ordered comfort food immediately.” — D14b:comfort@general, D10:act@general. You report choosing immediate comfort while stressed.
- **d** “Delayed eating until I could think clearly.” — D14b:delay@general, D10:wait@general. You report delaying the meal while stressed.

### q45 — You are about to sleep when an optional extra task appears. (chapter 6; hypothetical)
...
- **a** “Zero. A factual answer, not a confession.” — facts only; facts=movement=0 days / last 7. You explicitly report no deliberate movement days.
- **b** “One or two. Witnesses exist.” — facts only; facts=movement=1-2 days / last 7. You explicitly report occasional movement.
- **c** “Three or four. A recurring event.” — facts only; facts=movement=3-4 days / last 7. You explicitly report regular movement.
- **d** “Five to seven. My calendar has trainers on.” — facts only; facts=movement=5-7 days / last 7. You explicitly report frequent movement.

### q47 — What did you actually do the last time a movement plan met a hard day? (chapter 6; actual)

Choose a real response or skip.
- **a** “Kept the plan.” — D14c:planned@general. You report following the movement plan.
- **b** “Adapted it to fit the day.” — D14c:adjust@general, D3:plan@general. You report adapting the movement plan.
- **c** “Skipped it and did not replace it.” — D14c:skip@general. You report skipping the movement plan.
- **d** “Did a shorter version.” — D14c:adjust@general. You report reducing the movement plan.

### q48 — What did you actually do the last time a stranger or animal needed help? (chapter 6; actual)

Choose a real response or skip.
- **a** “Helped directly.” — D13:direct@general, D1:people@general. You report providing direct help.
- **b** “Connected them to someone better placed.” — D13:coordinate@general, D3:plan@general. You report coordinating appropriate help.
- **c** “Helped briefly, then left.” — D13:bounded@general. You report bounded help.
- **d** “Left because I had no safe capacity.” — D13:limit@general, D1:self@general. You report setting a capacity or safety limit.

### q49 — Your day has one free hour and three unfinished tasks. (chapter 7; hypothetical)
...
- **a** “Safety. I wanted the sensible, reliable choice.” — D4:security@general. You report prioritizing safety or reliability.
- **b** “Freedom. I wanted to save time or keep options open.” — D4:freedom@general. You report prioritizing independence or saved time.
- **c** “Enjoyment. I wanted the thing because it pleased me.” — D4:enjoyment@general. You report prioritizing enjoyment.
- **d** “Status. I liked being seen with that version.” — D4:status@general. You report prioritizing visible recognition.

### q51 — Your phone offers a limited-time deal while you are upset. (chapter 7; hypothetical)
...
### q54 — Your usual sleep plan meets an unexpectedly late night. (chapter 7; hypothetical)
...
### q56 — What did you actually do the last time your energy and obligation disagreed? (chapter 7; actual)
...
- **a** “Go. The map can explain itself later.” — D2:novel@general. You choose an unplanned novel experience.
- **b** “Check the details before saying yes.” — D2:conditional@general. You gather information first.
...
- **b** “Start warmly, then bring it up gently.” — D7:soften@close. You use a softer opening.
...
- **a** “Choose the reliable version and keep the rest safe.” — D4:security@general. You prioritize safety or reliability.
- **b** “Choose the option that saves time and opens choices.” — D4:freedom@general. You prioritize freedom or saved time.
- **c** “Choose the one that simply delights me.” — D4:enjoyment@general. You prioritize enjoyment.
- **d** “Choose the recognizable version.” — D4:status@general. You prioritize visible status.

### q61 — An extra task would help your team, but you are already out of battery. (chapter 8; holdout / heldout)

It is optional, and the team will survive a conversation.
- **a** “Decline and recover.” — D14d:rest@general. You protect recovery capacity.
- **b** “Take it on and finish the team’s need.” — D14d:obligation@general. You prioritize the team obligation.
...
- **b** “Apologize and explain what led to it.” — D12:explain@close. You combine an apology with context.
- **c** “Arrange a thoughtful concrete way to make up for it.” — D12:action@close. You initiate a concrete repair action.
- **d** “Agree on space and a time to reconnect.” — D12:pause@close. You coordinate space and a return.
...
- **a** “Choose a workable next step immediately.” — D3:improvise@general. You act quickly on a replacement step.
- **b** “Pause, gather details, and make a new plan.” — D3:plan@general. You organize before acting.
- **c** “Ask the affected people what they prefer, then plan around it.” — D3:consult@general. You consult before creating the next plan.
- **d** “Drop it; there is no capacity for a new version.” — D3:stop@general. You stop instead of making a replacement plan.
...
| --- | --- |
| q03 ↔ q08 | Trip first move/planning hypothetical ↔ actual response when a plan fails. |
...
| q44 ↔ q55 | Actual stressful dinner response ↔ new hypothetical stressful dinner. |
| q45 ↔ q54 | Sleep versus optional obligation ↔ same sleep/recovery tradeoff under a late night. |
