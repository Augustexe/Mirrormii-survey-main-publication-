...
function ShareKeepsake({ result, onExport }) {
  ...
  const captions = [card.caption, `Apparently I’m “${card.title}”. My friends have the floor.`, `Guess my Genii title before I tell you. Then take your own turn.`];
