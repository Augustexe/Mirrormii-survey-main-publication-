...
`../docs/` is a compatibility link to this folder, not another collection. The wrapper project's `context/` link reaches this same directory. Run outputs remain historical evidence, not competing editable masters. No run was deleted or merged into another run.
